...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-[#050530] via-[#040646] to-[#020038] flex items-center justify-center px-4 py-12">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl shadow-black/30">
          ...
          <div className="mt-6 text-center space-y-2">
            <Link to="/register" className="text-amber-400 hover:text-amber-300 text-sm transition-colors duration-300 block">
              إنشاء حساب جديد
            </Link>
            <Link to="/forgot-password" className="text-white/50 hover:text-white/70 text-sm transition-colors duration-300 block">
              نسيت كلمة المرور؟
            </Link>
          </div>
        </div>

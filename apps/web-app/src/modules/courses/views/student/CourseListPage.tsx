// src/modules/courses/pages/student/CourseListPage.tsx
...
const CourseListPage = () => {
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-b from-[#050530] via-[#040646] to-[#020038] px-4 py-8 md:py-16"
      dir="rtl"
    >
      {/* تأثير توهج خلفي */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-150 bg-gradient-to-r from-amber-400/5 to-blue-500/5 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        {/* شبكة البطاقات – نضمن أن courses مصفوفة */}

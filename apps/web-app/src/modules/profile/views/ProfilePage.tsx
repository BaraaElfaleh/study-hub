        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-1">
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 text-center">
              <div className="relative w-28 h-28 mx-auto mb-4">
                {profile.avatarUrl ? (
                  <img src={profile.avatarUrl} alt={fullName} className="w-full h-full rounded-full object-cover border-2 border-amber-400/50 shadow-lg" />
                ) : (
              ...
              <h2 className="text-2xl font-bold text-white mb-2">{fullName || 'مستخدم'}</h2>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
                  ...
                  <div key={idx} className="flex items-center justify-between bg-white/5 rounded-xl p-4 hover:bg-white/10 transition-colors">
                    <div>
                      ...
                      <div className="w-full h-1.5 bg-white/10 rounded-full mt-2 max-w-xs">
                        <div className="h-full bg-gradient-to-r from-amber-400 to-amber-500 rounded-full" style={{ width: `${course.progress}%` }} />
                      </div>
                    </div>
              ...
              {/* رابط my-courses تم حذفه لأنه لم يعد موجودًا */}
            </div>
          </div>
        </div>
